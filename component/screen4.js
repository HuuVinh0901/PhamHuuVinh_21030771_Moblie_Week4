    ...
    const products = [
        {
            ...
            rating: 4.5,
            bigImg: require('../assets/img/Container_7_(3).png'),
            img: require('../assets/img/Image_7_(4).png')
        },
        {
            id: 2,
            name: 'DONUT BLUE',
            ...
            rating: 4.0,
            bigImg: require('../assets/img/Container_7_(2).png'),
            img: require('../assets/img/Image_7_(2).png')
        },
        {
            id: 3,
            name: 'ORANGE',
            ...
            rating: 4.0,
            bigImg: require('../assets/img/Container_7_(1).png'),
            img: require('../assets/img/Image_7_(1).png')
        },
        {
            id: 4,
            name: 'CHERRY',
            ...
            rating: 4.0,
            bigImg: require('../assets/img/Container_7.png'),
            img: require('../assets/img/Image_7.png')
        },
    ];
        ...
        <View >
            ...
            <View style={{ marginLeft: 20, marginTop: 10 }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 5 }}>
                    ...
                    >
                        <Image style={{ borderRadius: 15, marginLeft: 10 }} source={require('../assets/img/Button_5.png')} />
